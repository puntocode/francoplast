...
<div class="container-fluid">
    <div class="row mt-4">
        <div class="col d-flex justify-content-between">
            <div>
                <h2 class=""><a href="{{ route('providers.index') }}" class="text-decoration-none"><i class="fas fa-arrow-left pr-2"></i></a>Crear Proveedor</h2>
                <p class="text-black-50">Complete el formulario para crear un nuevo proveedor</p>
            </div>
        </div>
    </div>
